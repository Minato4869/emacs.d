...
(let* ((BG-term                             (if (is_ssh) "color-235" "unspecified-bg"))
       ...
       (font-lock-builtin-face              (if gl/colours "#75507B" "#71a46c"))
       (font-lock-comment-face              (if gl/colours "#CC0000" "#5d5a58"))
       (font-lock-comment-delimiter-face    font-lock-comment-face)
       (font-lock-constant-face             (if gl/colours "#4E9A06" "#bd845f"))
       (font-lock-doc-face                  (if gl/colours "#4E9A06" font-lock-comment-face))
       (font-lock-function-name-face        (if gl/colours "#75507B" "#b680b1"))
       (font-lock-keyword-face              (if gl/colours "#729FCF" "#96905f"))
       (font-lock-negation-char-face        (if gl/colours nil       font-lock-constant-face))
       ...
       (font-lock-string-face               (if gl/colours "#4E9A06" "#71a19f"))
       (font-lock-type-face                 (if gl/colours "#4E9A06" "#8b8fc6"))
       (font-lock-variable-name-face        (if gl/colours "#C4A000" "#c27d7b"))
