...
(custom-theme-set-faces
 ...
 '(mode-line                           ((((class color) (background light)) (:background "#3E3E3D" :foreground "#d9d5ba"))
                                        (t                                  (:background "#292929" :inherit default))))
 '(mode-line-inactive                 ((t (:background "#4D4D4D" :foreground "#CCCCCC" :box (:line-width -1 :color "#666666" :style nil)))))
