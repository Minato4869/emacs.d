...
(let ((class '((class color) (min-colors 89)))
      ...
      ;; custom-variables
      (custom-mode-line-bg           "#BFBFBF")
      (custom-mode-line-fg           "#000000")
      (custom-mode-line-in-bg        "#666666")
      (custom-mode-line-bufid        "#00008B")
      (custom-region-bg              "#00077A"))
  ...
  (custom-theme-set-faces
   ...
   `(region ((,class (:background ,custom-region-bg :inherit foreground))))
   ...
   ;; Mode line faces
   `(mode-line ((,class (:background ,custom-mode-line-bg
                                    :foreground ,custom-mode-line-fg))))
   `(mode-line-inactive ((,class (:background ,custom-mode-line-in-bg
                                              :foreground
                                              ,custom-mode-line-fg))))
   `(mode-line-buffer-id ((,class (:foreground ,custom-mode-line-bufid :bold t))))
;;   `(mode-line ((,class
...
;;; custom-tango-dark-theme.el ends here
