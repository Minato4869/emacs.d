...
(custom-set-faces
 ...
 '(font-lock-fixme-face ((t (:foreground "Red" :bold t :underline t))) t)
 '(font-lock-important-face ((t (:foreground "Yellow" :bold t :underline t))) t)
 '(font-lock-note-face ((t (:foreground "Dark Green" :bold t :underline t))) t)
 '(font-lock-study-face ((t (:foreground "Yellow" :bold t :underline t))) t)
 '(hl-line ((t (:extend t))))
